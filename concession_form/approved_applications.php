<?php
  ...
  $row1=mysqli_fetch_array($query);
        ...
        $query1 = "SELECT reg_data.*, con_data.* FROM reg_data INNER JOIN con_data ON reg_data.prn_no = con_data.prn_no WHERE con_data.status = 1 ORDER BY con_data.id DESC ";
...
<body>
   ...
   <h3 align="center">Approved Applications</h3>
   <a href="pending_applications.php">Pending Applications</a>
                 ...
                 <?php
  				 ...
  				 ?>
                    ...
                    $new_rdate = date("d-m-Y", strtotime($rev_rdate));
                           ...
                           <label><td><button type="submit" onclick="undoalert()">Undo</button></td></label>
                           </form>
                           </tr>
    ...
    <script>
        ...
        function undoalert() 
        {
          alert("Are you sure you want to Undo this Application?");
        }
    </script>
</body>
</html>